...
- `backend/app/nlp/`: spaCy-based preprocessing, negation detection, and a per-domain lexicon-based behavioural cue extractor. Self-check against the synthetic dataset: 89.3% domain recall, 74.3% domain+status accuracy (`backend/ml/evaluate_cue_extraction.py`).
